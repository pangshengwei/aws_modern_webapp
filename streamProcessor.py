...
def retrieveMysfit(mysfitId):
    apiEndpoint = 'https://tghmr3zwha.execute-api.us-east-1.amazonaws.com/prod' + '/mysfits/' + str(mysfitId) # eg: 'https://ljqomqjzbf.execute-api.us-east-1.amazonaws.com/prod/'
